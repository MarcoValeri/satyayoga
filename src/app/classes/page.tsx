...
import EventbriteYogaClasses from "@/components/EventbriteYogaClasses/EventbriteYogaClasses";
    ...
    return (
        <>
            ...
            <div className={styles.classes}>
                <div className={styles.classes__container_title}>
                ...
                <div className={styles.classes__container_classes}>
