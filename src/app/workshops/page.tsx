    ...
    return (
        <>
            ...
            <div className={styles.workshop}>
                <div className={styles.workshop__container_title}>
                ...
                <div className={styles.workshop__container_workshops}>
                    {
                        workshopContent &&
                        workshopContent
                        .slice(0, showWorkshopsNum)
                        .map(workshop => (
                            <div key={workshop.id} className={styles.workshop__card_item}>
                                <CardWorkshop
                ...
                <div className={styles.workshop__container_button}>
                    {
